...
UPDATE riff SET content = REPLACE(content::TEXT, '"Pediatric Brain Tumor:', '"Kids First: Pediatric Brain Tumor:')::JSON;
UPDATE riff SET content = REPLACE(content::TEXT, '"Ewing Sarcoma:', '"Kids First: Ewing Sarcoma:')::JSON;
UPDATE riff SET content = REPLACE(content::TEXT, '"Neuroblastoma Initiation and Progression', '"Kids First: Neuroblastoma Initiation and Progression')::JSON;
...
UPDATE riff SET content = REPLACE(content::TEXT, '"Orofacial Cleft:', '"Kids First: Orofacial Cleft:')::JSON;
...
UPDATE riff SET content = REPLACE(content::TEXT, '"Enchondromatoses', '"Kids First: Enchondromatoses')::JSON;

/* The search queries in the file repository are stored as their full URL. The SQON is therefore URL-encoded: */
UPDATE riff SET content = REPLACE(content::TEXT, '%22Pediatric%20Brain%20Tumors%3A%20CBTTC', '%22Kids%20First%3A%20Pediatric%20Brain%20Tumors%3A%20CBTTC')::JSON;
...
UPDATE riff SET content = REPLACE(content::TEXT, '%22Neuroblastoma%20Initiation%20and%20Progression', '%22Kids%20First%3A%20Neuroblastoma%20Initiation%20and%20Progression')::JSON;
UPDATE riff SET content = REPLACE(content::TEXT, '%22Ewing%20Sarcoma%3A%20Genetic%20Risk', '%22Kids%20First%3A%20Ewing%20Sarcoma%3A%20Genetic%20Risk')::JSON;
...
UPDATE riff SET content = REPLACE(content::TEXT, '%22Enchondromatoses', '%22Kids%20First%3A%20Enchondromatoses')::JSON;
